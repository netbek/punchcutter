...
sudo apt-get purge -y -qq libharfbuzz* ttfautohint

sudo apt-get install -y -qq autoconf automake bison flex git pkg-config gcc g++ libglib2.0-dev libcairo2-dev libtool libc6 libfreetype6 libgcc1 libqtcore4 libqtgui4 libstdc++6 libqt4-dev libfreetype6-dev pandoc pkg-config texlive-xetex help2man
