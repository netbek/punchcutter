...
Punchcutter.prototype = {
  ...
  loadFiles: function(src) {
    return multiGlob(src).then(function(matched) {
      var files = [];
  ...
  buildJsFont: function(config) {
    ...
    return this.loadFiles(config.src)
      ...
      .then(function(files) {
        ...
        var data =
          config.js.prepend + JSON.stringify(map, null, 2) + config.js.append;
